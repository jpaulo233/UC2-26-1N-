...
let fraseDoUsuario = ask.question("Digite uma frase: ")


console.log(fraseDoUsuario)
console.log(fraseDoUsuario.toUpperCase())
console.log(fraseDoUsuario.toLowerCase())
...
let frutas = ["maca,banana,uva,abacaxi,pera"]
let frutas = ask.question("Escolha uma fruta")
